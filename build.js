...
const newWorks = [
  ...
  { img: "new-09", concept: "A personal piece about my relationship with my parents and the shape our family took. The large angry figure on the left is my mother, looming and controlling, her agenda pressed onto everything around her. In the middle is me, mouth shut and made small, muted and unhappy and trapped in the space between them. My father sits on the right, small because his role was small, present but rarely saying much or letting his own opinions or personality show. Each of them wears a tie, the quiet mark of a working class family and the strain of getting by.", tech: "Oil on canvas.", size: "On request", medium: "Oil on canvas", year: "2026", price: "Price on request" },

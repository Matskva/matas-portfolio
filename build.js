...
const newWorks = [
  ...
  { img: "new-05", concept: "Speaks to being lost in an environment that never stops shifting, learning to adapt to everything around you without ever letting it swallow you whole. The vibrant yellow pulls the figure forward and holds it clear of the ground behind, a self that bends with its surroundings yet refuses to dissolve into them. It is a portrait of survival through adaptation, staying whole while everything else keeps changing.", tech: "Oil on canvas.", size: "120 × 120 cm", medium: "Oil on canvas", year: "2025", price: "unavailable" },
  { img: "new-06", concept: "A collaborative piece about the connection between a person and the natural world, the hair growing outward into the landscape as though the two were never truly apart. Behind the figure a ghostly presence follows close, the shape of a resentful and regretful past that refuses to be left behind. It lingers as a reminder that wherever you go, everything that came before you comes too.", tech: "Oil on canvas.", size: "100 × 100 cm", medium: "Oil on canvas", year: "2026", price: "Price on request" },
  { img: "new-07", concept: "Carries the pride of the Lithuanian symbol, a reconnection with my roots and a wish to hold them close rather than hide them away. The red figure is my own consciousness pushing through the surface of the painting, looking out and seeing my country clearly, for everything it is and everything it has been. It is an act of belonging, claiming a heritage without shame and wearing it openly.", tech: "Oil on canvas.", size: "60 × 60 cm", medium: "Oil on canvas", year: "2026", price: "Price on request" },
  { img: "new-08", concept: "A collaborative piece made as the cover for an upcoming music album. The faces are painted in the pan African colours, worn openly across the head as a mark of identity and belonging. The red ground behind them holds the frustration of the circumstances, the weight of having to sit still and keep from escalating when met with discrimination, of not being free to react the way others can when their skin happens to be a different colour to yours.", tech: "Oil on canvas.", size: "75 × 70 cm", medium: "Oil on canvas", year: "2026", price: "Price on request" },
  { img: "new-09", concept: "A personal piece about my relationship with my parents and the shape our family took. The large angry figure on the left is my mother, looming and controlling, her agenda pressed onto everything around her. In the middle is me, mouth shut and made small, muted and unhappy and trapped in the space between them. My father sits on the right, small because his role was small, present but rarely saying much or letting his own opinions or personality show. Each of them wears a tie, the quiet mark of a working class family and the strain of getting by.", tech: "Oil on canvas.", size: "210 × 150 cm", medium: "Oil on canvas", year: "2026", price: "Price on request" },
